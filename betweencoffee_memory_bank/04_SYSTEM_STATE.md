...
- 2026-09-15 `.ftco-section-blank-small` 留白縮小 30%：樣式綁 class（非標籤），故在 bc-components.css 覆蓋 8em/26vh → 5.6em/18.2vh 並同步三組 media query（×0.7）；同日再縮 20%（全面 ×0.8）→ 實測 224px → 156.8px → 125.4px（累計 −44%）；版號 ?v=20260915b
