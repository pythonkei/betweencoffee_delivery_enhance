...
# 桌面照片寬度（vw，2026-08-21 不壓字+填滿：縮小使照片行文字容納）
DESK_W = {1: 6.0, 2: 3.0, 3: 3.0, 4: 4.0, 5: 3.0, 6: 6.0, 7: 2.5}
# 行動版（2026-08-21 不壓字+佔≤2行：thum--1/4 縮小至 12/13vw）；thum--6/7 固定框
SP_W = {1: 12.0, 2: 17.3333333333, 3: 17.0666666667, 4: 13.0}
SP_FIXED = {6: (13.8666666667, 12.0), 7: (18.6666666667, 12.5333333333)}
