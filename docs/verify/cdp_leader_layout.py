...
async def main():
    # 桌面 1280px：li 起點 367；縮排 li--1/2 +13.18vw≈169、li--6 +6.44vw≈82、li--11~13 +10.61vw≈136
    desk_expected = [536, 536, 367, 367, 367, 449, 367, 367, 367, 367, 503, 503, 503]
    # 行動 375px：li 起點 40；縮排 li--1~3 +31.2vw≈117、li--11/12 +22.67vw≈85、li--16~18 +17.33vw≈65
