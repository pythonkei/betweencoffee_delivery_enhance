...
urlpatterns = [
    ...
    path(
        "fps/<int:order_id>/confirm/", fps_confirm_payment, name="fps_confirm_payment"
    ),
    path("cash/<int:order_id>/", cash_payment, name="cash_payment"),
    path(
        "cash/<int:order_id>/confirm/",
        cash_confirm_payment,
        name="cash_confirm_payment",
    ),
    # 支付检查
    path(
        "check-status/<int:order_id>/",
        check_and_update_payment_status,
        name="check_payment_status",
    ),
    path(
        "check-timeout/<int:order_id>/",
        check_payment_timeout,
        name="check_payment_timeout",
    ),
    path(
        "cancel-timeout/<int:order_id>/",
        cancel_timeout_payment,
        name="cancel_timeout_payment",
    ),
    # 支付优化路由
    path(
        "query-status/<int:order_id>/",
        query_payment_status,
    ...
    path(
        "test-cancel/<int:order_id>/", test_payment_cancel, name="test_payment_cancel"
    ),
    path(
        "simulate-alipay-cancel/<int:order_id>/",
        simulate_alipay_cancel,
        name="simulate_alipay_cancel",
    ),
]
