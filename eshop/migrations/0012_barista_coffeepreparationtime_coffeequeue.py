    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_load",
                    models.PositiveIntegerField(default=0, verbose_name="当前负载"),
                ),
            ],
            options={
                "verbose_name": "咖啡师",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "coffee_type",
                    models.CharField(max_length=100, verbose_name="咖啡类型"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "position",
                    models.PositiveIntegerField(default=0, verbose_name="队列位置"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="预计开始时间"
                    ),
                ),
                (
                ...
                (
                    "coffee_count",
                    models.PositiveIntegerField(default=0, verbose_name="咖啡杯数"),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="eshop_coffe_estimat_548772_idx",
                    ),
                ],
            },
        ),
