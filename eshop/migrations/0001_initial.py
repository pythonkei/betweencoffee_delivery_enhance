    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(blank=True, default="", max_length=80, null=True),
                ),
                ...
                (
                    "is_quick_order",
                    models.BooleanField(
                        default=False, help_text="優先處理", verbose_name="快速訂單"
                    ),
                ),
                ...
                (
                    "fps_qr_code",
                    models.TextField(blank=True, null=True, verbose_name="FPS二维码"),
                ),
                (
                    "user",
                    models.ForeignKey(
