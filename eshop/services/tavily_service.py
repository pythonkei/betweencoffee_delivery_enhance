...
class TavilyService:
    ...
    def search_with_options(self, query: str, **options) -> Dict[str, Any]:
        ...
        payload = {"api_key": self.api_key, "query": query, **options}
    ...
    def research_coffee_market(
        self, location: str = "香港", year: str = "2024"
    ) -> Dict[str, Any]:
        """
        研究咖啡市場
        ...
        results = self.search(
            query=query, max_results=8, include_answer=True, search_depth="advanced"
        )
    ...
    def analyze_competitors(self, competitors: List[str] = None) -> Dict[str, Any]:
        ...
        for competitor in competitors:
            ...
            results = self.search(query=query, max_results=5, include_answer=True)
    ...
    def solve_technical_issue(
        self, issue: str, technology: str = "Django"
    ) -> Dict[str, Any]:
        """
        解決技術問題
        ...
        results = self.search(
            query=query, max_results=6, include_answer=True, search_depth="advanced"
        )
    ...
    def research_pricing_strategies(self) -> Dict[str, Any]:
        ...
        for topic in topics:
            ...
            results = self.search(query=query, max_results=4, include_answer=True)
    ...
    def _analyze_market_trends(self, results: Dict[str, Any]) -> Dict[str, Any]:
        """分析市場趨勢"""
        trends = {"growth_areas": [], "challenges": [], "opportunities": []}
    ...
    def _extract_price_range(self, results: Dict[str, Any]) -> Dict[str, Any]:
        """提取價格範圍"""
        price_range = {"min": None, "max": None, "average": None, "currency": "HKD"}
