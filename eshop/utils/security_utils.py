...
class SecurityUtils:
    ...
    def check_password_strength(self, password: str) -> Dict[str, Any]:
        ...
        """
        if not password:
            return {"valid": False, "score": 0, "issues": ["密碼不能為空"]}
    ...
    def encrypt_sensitive_data(self, data: str, key: str = None) -> str:
        ...
        try:
            ...
            self.log_security_event(
                "warning", "crypto_library_missing", {"data_length": len(data)}
            )
    ...
    def decrypt_sensitive_data(self, encrypted_data: str, key: str = None) -> str:
        ...
        try:
            ...
            self.log_security_event(
                "error",
                "decryption_failed",
                {"error": str(e), "data_length": len(encrypted_data)},
            )
            raise
    ...
    def log_security_event(
        self, level: str, event_type: str, details: Dict[str, Any] = None
    ):
        """
        記錄安全事件
    ...
    def check_rate_limit(
        self, identifier: str, endpoint: str, limit: int = 100, window_minutes: int = 60
    ) -> Dict[str, Any]:
        """
        檢查速率限制
    ...
    def check_security_configuration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            checks["secret_key"] = {
                "configured": secret_key is not None
                and secret_key != "your-secret-key-here",
            ...
            # 添加其他基本檢查
            checks["python_version"] = {"version": sys.version, "recommended": "3.8+"}
        ...
        # 計算總體評分
        passed_checks = sum(
            1 for check in checks.values() if not check.get("warning", False)
        )
...
def check_rate_limit(
    identifier: str, endpoint: str, limit: int = 100, window_minutes: int = 60
) -> Dict[str, Any]:
    """快捷函數：檢查速率限制"""
...
if __name__ == "__main__":
    ...
    rate_limit_result = check_rate_limit(
        "test_user", "/api/test", limit=5, window_minutes=1
    )
