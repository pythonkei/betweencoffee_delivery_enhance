...
class TimeValidators:
    ...
    def is_within_time_range(target_time, start_time, end_time):
        ...
        if not all(
            [
                TimeValidators.is_valid_datetime(t)
                for t in [target_time, start_time, end_time]
            ]
        ):
            return False
    ...
    def validate_order_timing(order):
        ...
        try:
            ...
            if order.order_type == "quick" and has_coffee:
                ...
                elif not TimeValidators.is_valid_pickup_choice(
                ...
                if order.latest_start_time:
                    is_urgent, remaining = (
                        TimeValidators.is_time_urgent_for_quick_order(
