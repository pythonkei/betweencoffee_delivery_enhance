...
class SecurityConfig:
    ...
    def _load_settings(self):
        ...
        try:
            ...
            self.API_SECURITY.update(getattr(settings, "SECURITY_API_CONFIG", {}))
            ...
            self.BACKUP_SECURITY.update(getattr(settings, "SECURITY_BACKUP_CONFIG", {}))
    ...
    def validate_configuration(self) -> Dict[str, Any]:
        ...
        custom_checks["api_security"] = {
            ...
            "cors_restrictive": len(api_security["cors_allowed_origins"]) == 0
            or "*" not in api_security["cors_allowed_origins"],
        }
    ...
    def generate_security_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "status": (
                "secure"
                if config_validation["overall_score"] >= 80
